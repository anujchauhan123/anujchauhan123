...
var KanbanController = BasicController.extend({
    ...
    renderButtons: function ($node) {
        ...
        this.$buttons.on('click', 'button.o_button_business_loan', this._onButtonBusinessLoan.bind(this));
        this.$buttons.on('click', 'button.o_button_personal_loan', this._onButtonPersonalLoan.bind(this));
        this.$buttons.on('click', 'button.o_button_home_loan', this._onButtonHomeLoan.bind(this));
        this.$buttons.on('click', 'button.o_button_lap', this._onButtonLap.bind(this));
     ...
     * @private
     */
    _onButtonBusinessLoan: function () {
        return this.do_action('capwise_crm.crm_lead_opportunities_capwise_lead_business_loan', {
          // additional_context: {
     ...
     * @private
     */
    _onButtonPersonalLoan: function () {
        return this.do_action('capwise_crm.crm_lead_opportunities_capwise_lead_personal_loan', {
          // additional_context: {
          //     default_orderpoint_ids: recordResIds
          // },
          // on_close: () => self.do_action('stock.action_replenishment')
     ...
     * @private
     */
    _onButtonHomeLoan: function () {
        return this.do_action('capwise_crm.crm_lead_opportunities_capwise_lead_home_loan', {
          // additional_context: {
          //     default_orderpoint_ids: recordResIds
          // },
          // on_close: () => self.do_action('stock.action_replenishment')
     ...
     * @private
     */
    _onButtonLap: function () {
        return this.do_action('capwise_crm.crm_lead_opportunities_capwise_lead_lap_loan', {
          // additional_context: {
          //     default_orderpoint_ids: recordResIds
          // },
          // on_close: () => self.do_action('stock.action_replenishment')
