...
var HrDashboard = AbstractAction.extend({
    ...
    jsLibs: [
     ...
     events: {
             'click .total_leads_click':'total_leads_click',
             'click #total_login' : 'total_login',
             'click #business_loan_lead':'business_loan_lead',
             'click #personal_loan_lead':'personal_loan_lead',
             'click #home_loan_lead':'home_loan_lead',
             'click #lap_leads':'lap_leads',
             'dblclick .total_leads_click' : 'total_leads_double_click',
             'click #channel_unassigned' : 'channel_unassigned',

             'click #total_lead_bl' : 'total_lead_bl',
            'click #total_logins_bl' : 'total_logins_bl',
            'click #total_sanction_bl' : 'total_sanction_bl',
            'click #total_disbursed_bl' : 'total_disbursed_bl',
            'click #total_lead_pl' : 'total_lead_pl',
            'click #total_logins_pl' : 'total_logins_pl',
            'click #total_sanction_pl' : 'total_sanction_pl',
            'click #total_disbursed_pl' : 'total_disbursed_pl',
            'click #total_lead_hl' : 'total_lead_hl',
            'click #total_logins_hl' : 'total_logins_hl',
            'click #total_sanction_hl' : 'total_sanction_hl',
            'click #total_disbursed_hl' : 'total_disbursed_hl',
            'click #total_lead_lap' : 'total_lead_lap',
            'click #total_logins_lap' : 'total_logins_lap',
            'click #total_sanction_lap' : 'total_sanction_lap',
            'click #total_disbursed_lap' : 'total_disbursed_lap',

             'click #dsa_lead': 'leaves_to_approve',
             ...
             'click #dsa_onboard':'leaves_request_today',
    ...
    total_leads_double_click: function(e) {
         var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
    ...
    total_logins_bl : function(e) {
        ...
        this.do_action({
            name: _t("Login Business Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','bl'],['login_date_with_Bank_NBFC' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_sanction_bl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Sanction Business Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','bl'],['sanction_date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_disbursed_bl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Disbursed Business Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','bl'],['disb_Date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_lead_pl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
    ...
    total_logins_pl : function(e) {
        ...
        this.do_action({
            name: _t("Login Personal Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','pl'],['login_date_with_Bank_NBFC' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_sanction_pl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Sanction Personal Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','pl'],['sanction_date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_disbursed_pl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Disbursed Personal Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','pl'],['disb_Date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_lead_hl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
    ...
    total_logins_hl : function(e) {
        ...
        this.do_action({
            ...
            domain: [['loan_type','=','hl'],['login_date_with_Bank_NBFC' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_sanction_hl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Sanction Home Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','hl'],['sanction_date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_disbursed_hl : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Disbursed Home Loan Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
            ...
            domain: [['loan_type','=','hl'],['disb_Date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_lead_lap : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            ...
            domain: [['loan_type','=','lap']],
            target: 'current'
        }, options)
    },
    total_logins_lap : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            ...
            domain: [['loan_type','=','lap'],['login_date_with_Bank_NBFC' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_sanction_lap : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            ...
            domain: [['loan_type','=','lap'],['sanction_date' ,'!=', false]],
            target: 'current'
        }, options)
    },
    total_disbursed_lap : function(e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            ...
            domain: [['loan_type','=','lap'],['disb_Date' ,'!=', false]],
            target: 'current'
        }, options)
    },

    channel_unassigned: function(e) {
         var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Channel Unassigned Lead"),
            type: 'ir.actions.act_window',
            res_model: 'crm.lead',
            view_mode: 'tree,form',
            views: [[false, 'list'], [false, 'form']],
    ...
    total_login: function(e) {
        ...
        this.do_action({
            ...
            domain: [['login_date_with_Bank_NBFC' ,'!=', false]],
            target: 'current'
        }, options)
    },
     ...
     total_leads_click: function(ev){
        var self = this;
            // ev.stopPropagation();
            // ev.preventDefault();
           var $action = $(ev.currentTarget);
           console.log("$action@@@@@@@@@@@@@",$action)
           var collection = document.getElementById("loan_area");
           console.log("collection@@@@@@@@@@@@@@",loan_area)
           // .css("display", "block");
           if($('#loan_area').css('display') == 'flex')
            {
                $('#loan_area').css('display',"none");
                $('#bl_status').css('display',"none");
                $('#pl_status').css('display',"none");
                $('#hl_status').css('display',"none");
                $('#lap_status').css('display',"none");
                
            }
            else{
                $('#loan_area').css('display',"flex");
            }

     },

     business_loan_lead: function(ev){
        var self = this;
            // ev.stopPropagation();
            // ev.preventDefault();
           var $action = $(ev.currentTarget);
     ...
     personal_loan_lead: function(ev){
        var self = this;
            // ev.stopPropagation();
            // ev.preventDefault();
           var $action = $(ev.currentTarget);
     ...
     lap_leads: function(ev){
        var self = this;
           ...
           // console.log("collection@@@@@@@@@@@@@@",loan_area)
           // .css("display", "block");
           if($('#lap_status').css('display') == 'flex')
            {
    ...
    employee_broad_factor: function(e) {
        ...
        this.do_action({
            name: _t("Total Disbursed Lead"),
            type: 'ir.actions.act_window',
            res_model: 'capwise.lead',
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['disb_Date' ,'!=', false]],
            target: 'current',
        }, options)
    ...
    hr_contract: function(e){
            ...
            e.preventDefault();
                    ...
                    self.do_action({
                        name: _t("Total Sanction"),
                        type: 'ir.actions.act_window',
                        res_model: 'capwise.lead',
                        view_mode: 'tree,form,calendar',
                        views: [[false, 'list'],[false, 'form']],
                        domain : [['sanction_date' ,'!=', false]],
                        target: 'current'
                    })
